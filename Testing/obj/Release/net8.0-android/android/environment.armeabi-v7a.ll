...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1816479739, ; hash 0x6c4547fb, from name: aot-Testing.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 2297869813, ; hash 0x88f6b5f5, from name: libaot-Testing.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 251
	...
	%struct.DSOCacheEntry {
		i64 2301194007, ; hash 0x89296f17, from name: aot-Testing
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 253
	...
	%struct.DSOCacheEntry {
		i64 2933018701, ; hash 0xaed2504d, from name: Testing.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 327
	...
	%struct.DSOCacheEntry {
		i64 3187685972, ; hash 0xbe003a54, from name: Testing
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 364
	...
	%struct.DSOCacheEntry {
		i64 3343700516, ; hash 0xc74cd224, from name: libaot-Testing
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 378
