...
@dso_cache = dso_local local_unnamed_addr global [474 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 2214461105341693616, ; hash 0x1ebb58a480cf7eb0, from name: aot-Testing
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 51
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 3506138006682880407, ; hash 0x30a84df0d5d44997, from name: Testing
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 89
	...
	%struct.DSOCacheEntry {
		i64 6278922339878107700, ; hash 0x57233699d8b2fa34, from name: aot-Testing.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 138
	%struct.DSOCacheEntry {
		i64 6292672751104571643, ; hash 0x57541086f15e38fb, from name: libaot-Testing.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 139
	...
	%struct.DSOCacheEntry {
		i64 9174765355856608676, ; hash 0x7f53507b2d64bda4, from name: Testing.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 232
	...
	%struct.DSOCacheEntry {
		i64 15933118411415287438, ; hash 0xdd1dcec724a4f68e, from name: libaot-Testing
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Testing.dll.so
		ptr null; void* handle (0x0)
	}, ; 410
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f899fab8-b3f3-4134-ba07-b75c58568724\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.testing\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-Testing.dll.so\00", align 16
